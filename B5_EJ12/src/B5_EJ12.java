...
public class B5_EJ12 {

	public static void main(String[] args) {
		byte[][] aMatriz = {{5,1,3,8},{1,8,2,9},{3,2,5,3},{8,9,3,5}};
//		byte[][] aMatriz = {{1,1,1,1},{1,8,2,9},{3,2,5,3},{8,9,3,5}};
//		int[][] aMatrizInt = crearMatrizRandomInt(5, 5, 1, 2000000);
		
		System.out.println(imprimeMatrizByte(aMatriz));
		
		if (esMatrizSimetrica(byteToIntMatriz(aMatriz))) {
			System.out.println("La Matriz ES simetrica");
		} else {
			System.out.println("La Matriz No es simetrica");
		}
		
//		System.out.println(imprimeMatrizInt(aMatrizInt));
//		
//		if (esMatrizSimetrica(aMatrizInt)) {
//			System.out.println("La Matriz ES simetrica");
//		} else {
//			System.out.println("La Matriz No es simetrica");
//		}
	...
	private static boolean esMatrizSimetrica(int[][] aMatriz) { //El tipado es int para crear una funcion reutilizable.
