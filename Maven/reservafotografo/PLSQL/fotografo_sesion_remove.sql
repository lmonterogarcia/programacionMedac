CREATE DEFINER=`fotografo`@`%` PROCEDURE `reservafotografo`.`fotografo_sesion_remove`(IN oObject JSON)
BEGIN
	...
	ELSE
        ...
        IF vItems > 0 THEN 
            WHILE vIndex < vItems DO
            	...
            	DELETE FROM Fotografo_Sesion  WHERE dniFotografo = dniFotografoParam AND idSesion = idSesionParam;
