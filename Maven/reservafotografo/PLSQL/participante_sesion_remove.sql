CREATE DEFINER=`fotografo`@`%` PROCEDURE `reservafotografo`.`participante_sesion_remove`(IN oObject JSON)
BEGIN
	...
	ELSE
        ...
        IF vItems > 0 THEN 
            WHILE vIndex < vItems DO
            	...
            	DELETE FROM Participante_Sesion  WHERE idParticipante = idParticipanteParam AND idSesion = idSesionParam;
