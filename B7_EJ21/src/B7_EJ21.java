...
public class B7_EJ21 {

	public static void main(String[] args) {

		byte bNumeroTotalTerminos = (byte) leer("Introduce el numero de terminos que quiere de la serie de Fibonacci ",
				1, 120, -1, -1, (byte) 1);

		String sSerieFibonacci = sucesionFobonacci(bNumeroTotalTerminos);

		System.out.println(sSerieFibonacci);

	}

	private static String sucesionFobonacci(int iNumeroTerminos) {
		double dNumeroTermino1, dNumeroTermino2 = -1, dNumeroTermino3 = 1;
		String sSerieFibonacci = "";

		for (int iContadorTerminos = 1; iContadorTerminos <= (iNumeroTerminos); iContadorTerminos++) {
			dNumeroTermino1 = dNumeroTermino2;
			dNumeroTermino2 = dNumeroTermino3;
			dNumeroTermino3 = dNumeroTermino1 + dNumeroTermino2;
			
			if (dNumeroTermino3 < Long.MAX_VALUE ) {
				sSerieFibonacci += (long) dNumeroTermino3 + ", ";
			} else {
				sSerieFibonacci += dNumeroTermino3 + ", ";
			}
