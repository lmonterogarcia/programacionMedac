...
public class B5_EJ7 {
	...
	public static void main(String[] args) {
		byte[] aVector = crearVectorRandomByte(100, (byte) 1, (byte) 9);

		int iPosicionesK = (int) leer("Cuantos lugares quiere que se mueva?", 0, 100, -1, -1, (byte) 3);
		System.out.println( imprimeVectorByte( aVector));
		aVector = intToByteVector( moverPosicionesVector( byteToIntVector( aVector), iPosicionesK));
		System.out.println( imprimeVectorByte( aVector));

		/*
		 * Ya que los elementos del vector se mueven circularmente, empezar en un
		 * elemento u otro es irrelevante. Por esto se ha obviade la variable
		 * "posicion p".
		 * 
		 */
	}
