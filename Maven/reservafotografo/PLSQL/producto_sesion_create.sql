CREATE DEFINER=`fotografo`@`%` PROCEDURE `reservafotografo`.`producto_sesion_create`(IN oObject JSON)
BEGIN
	...
	ELSE
        ...
        IF vItems > 0 THEN 
            WHILE vIndex < vItems DO
                ...
                INSERT INTO Producto_Sesion VALUES (idSesionParam, `nombreProductoParam`);
