...
public class B10_P5 {
	...
	public static void main(String[] args) {
		Persona oPersona1 = new Persona("Luis", "Montero", "Garcia-Manjaron");
	...
	private static void demostrarClase(Persona oPersona1) {
		...
		System.out.println(cambioEstado((byte) IPersona.BSOLTERO, oPersona1));
		System.out.println(cambioEstado((byte) IPersona.BVIUDO, oPersona1));
		System.out.println(cambioEstado((byte) IPersona.BCASADO, oPersona1));
