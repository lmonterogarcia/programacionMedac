...
public class B7_EJ35 {

	public static void main(String[] args) {
		String sMensaje = "ÃŽÃ™Ã±Ã™Â˜Ã†Ã™Ã®Ã¡ÃœÃ™ÃœÃ�Ã«Â˜Ã©Ã­Ã�Â˜Ã¥Ã�Â˜Ã Ã™Ã«Â˜ÃœÃ™ÃœÃ§";//Metodo ASCII
//		String sMensaje = (leer("Introduce el mensaje encriptado: ", -1, -1, -1, -1, (byte) 9).toString());

//		byte bClave = (byte) leer("Introduce la clave numerica para desencriptar el mensaje ", 1, 50, -1, -1, (byte) 1); // 11 para saber el mensaje.
		byte bClave = (byte) leer("Introduce la clave numerica para encriptar el mensaje ", 1, 120, -1, -1, (byte) 1);//Utilizar con el metodo ASCII. 120 para saber el mensaje.
		System.out.println("\nMensaje desencriptado:\n" + desencriptarMensaje(stringSimpleToCharVector(sMensaje), bClave));
	 ...
	 *
	 *
	 * Siempre el codigo es creado para ser reutilizado. Por lo que la mayoria de
	 * las veces el tipado es int',' a no ser que sea muy especifica del
	 * Ejercicio/Problema.
	 */

	private static String desencriptarMensaje(char[] aMensaje, byte bClave) {

		//Version 1
//		String sMensaje = "";
//		char[] aAlfabeto = { 'A', 'a', '9', 'E', 'e', 'I', 'i', 'O', 'o', '3', 'U', 'u', 'B', 'b', 'C', 'c', '7', 'D',
//				'd', 'F', 'f', 'G', 'g', 'H', 'h', 'J', 'j', '6', 'K', 'k', 'L', 'l', '5', 'M', 'm', '2', 'N', 'n', '8',
//				'P', 'p', '4', 'Q', 'q', 'R', 'r', '1', 'S', 's', 'T', 't', 'V', 'v', 'W', 'w', 'X', 'x', 'Y', 'y', 'Z',
//				'z', '0' };
//		boolean booEsElCaracter;
//		byte bContadorAlfabeto;
//
//		for (int iContador = 0; iContador < aMensaje.length; iContador++) {
//
//			booEsElCaracter = false;
//			bContadorAlfabeto = 0;
//
//			do {
//
//				if (aMensaje[iContador] == aAlfabeto[bContadorAlfabeto]) {
//					booEsElCaracter = true;
//				}
//
//				bContadorAlfabeto++;
//			} while (!booEsElCaracter && bContadorAlfabeto < aAlfabeto.length);
//
//			if (booEsElCaracter) {
//
//				if (((bContadorAlfabeto - 1) - bClave) < 0) {
//					sMensaje += aAlfabeto[(aAlfabeto.length - 1) - ((bClave - (bContadorAlfabeto - 1)) - 1)];
//				} else {
//					sMensaje += aAlfabeto[(bContadorAlfabeto - 1) - bClave];
//				}
//
//			} else {
//				sMensaje += aMensaje[iContador];
//			}
//
//		}
		
		//Version 2.Con tabla ASCII
		String sMensaje = "";
		byte bInicioAbc = 32;
		short shFinalAbc = 254;
		
		for (int iContador = 0; iContador < aMensaje.length; iContador++) {

				if (aMensaje[iContador] - bClave < bInicioAbc ) {
					sMensaje += (char)(shFinalAbc - (bClave - (aMensaje[iContador] - bInicioAbc)));
				} else {
					sMensaje += (char)(aMensaje[iContador] - bClave);
				}
...
//	Nueva funcion para Libreria Leer. Lee un double dentro de un rango sin llegar a los limites
	...
	// Leer
	// VECTOR##########################################################################
	private static Object[] leerVector(String sMensaje, int iTamanio, long lMinimo, long lMaximo, double dMinimo,
			double dMaximo, byte bEstado) {
	...
	public static Object[] pideVectorFloat(String sMensaje, int iTamanio, double dMin, double dMax) {
		...
		for (int iContador = 0; iContador < aVector.length; iContador++) {
			aVector[iContador] = (float) leer(sMensaje + (iContador + 1) + ": ", -1, -1, dMin, dMax, (byte) 5);
		}
	...
	public static Object[] pideVectorDouble(String sMensaje, int iTamanio, double dMin, double dMax) {
		...
		for (int iContador = 0; iContador < aVector.length; iContador++) {
			aVector[iContador] = (double) leer(sMensaje + (iContador + 1) + ": ", -1, -1, dMin, dMax, (byte) 6);
		}
	...
	public static Object[] pideVectorChar(String sMensaje, int iTamanio) {
		...
		for (int iContador = 0; iContador < aVector.length; iContador++) {
			aVector[iContador] = (char) leer(sMensaje + (iContador + 1) + "/" + aVector.length + ": ", -1, -1, -1, -1,
					(byte) 8);
		}
	...
	// Leer
	// MATRIZ##########################################################################
	private static Object[][] leerMatriz(String sMensaje, int iFilas, int iColumnas, long lMinimo, long lMaximo,
			double dMinimo, double dMaximo, byte bEstado) {
	...
	public static Object[][] pideMatrizByte(String sMensaje, int iFilas, int iColumnas, long lMin, long lMax) {
		...
		for (int iContadorFila = 0; iContadorFila < aVector.length; iContadorFila++) {
			for (int iContadorColumna = 0; iContadorColumna < aVector[0].length; iContadorColumna++) {
				aVector[iContadorFila][iContadorColumna] = (byte) leer(
						sMensaje + "[" + iContadorFila + "]" + "[" + iContadorColumna + "]" + ": ", (long) lMin,
						(long) lMax, -1, -1, (byte) 1);
			}
		}
	...
	public static Object[][] pideMatrizShort(String sMensaje, int iFilas, int iColumnas, long lMin, long lMax) {
		...
		for (int iContadorFila = 0; iContadorFila < aVector.length; iContadorFila++) {
			for (int iContadorColumna = 0; iContadorColumna < aVector[0].length; iContadorColumna++) {
				aVector[iContadorFila][iContadorColumna] = (short) leer(
						sMensaje + "[" + iContadorFila + "]" + "[" + iContadorColumna + "]" + ": ", (long) lMin,
						(long) lMax, -1, -1, (byte) 2);
			}
		}
	...
	public static Object[][] pideMatrizInt(String sMensaje, int iFilas, int iColumnas, long lMin, long lMax) {
		...
		for (int iContadorFila = 0; iContadorFila < aVector.length; iContadorFila++) {
			for (int iContadorColumna = 0; iContadorColumna < aVector[0].length; iContadorColumna++) {
				aVector[iContadorFila][iContadorColumna] = (int) leer(
						sMensaje + "[" + iContadorFila + "]" + "[" + iContadorColumna + "]" + ": ", (long) lMin,
						(long) lMax, -1, -1, (byte) 3);
			}
		}
	...
	public static Object[][] pideMatrizLong(String sMensaje, int iFilas, int iColumnas, long lMin, long lMax) {
		...
		for (int iContadorFila = 0; iContadorFila < aVector.length; iContadorFila++) {
			for (int iContadorColumna = 0; iContadorColumna < aVector[0].length; iContadorColumna++) {
				aVector[iContadorFila][iContadorColumna] = (long) leer(
						sMensaje + "[" + iContadorFila + "]" + "[" + iContadorColumna + "]" + ": ", (long) lMin,
						(long) lMax, -1, -1, (byte) 4);
			}
		}
	...
	public static Object[][] pideMatrizFloat(String sMensaje, int iFilas, int iColumnas, double dMin, double dMax) {
		...
		for (int iContadorFila = 0; iContadorFila < aVector.length; iContadorFila++) {
			for (int iContadorColumna = 0; iContadorColumna < aVector[0].length; iContadorColumna++) {
				aVector[iContadorFila][iContadorColumna] = (float) leer(
						sMensaje + "[" + iContadorFila + "]" + "[" + iContadorColumna + "]" + ": ", -1, -1, dMin, dMax,
						(byte) 5);
			}
		}
	...
	public static Object[][] pideMatrizDouble(String sMensaje, int iFilas, int iColumnas, double dMin, double dMax) {
		...
		for (int iContadorFila = 0; iContadorFila < aVector.length; iContadorFila++) {
			for (int iContadorColumna = 0; iContadorColumna < aVector[0].length; iContadorColumna++) {
				aVector[iContadorFila][iContadorColumna] = (double) leer(
						sMensaje + "[" + iContadorFila + "]" + "[" + iContadorColumna + "]" + ": ", -1, -1, dMin, dMax,
						(byte) 6);
			}
		}
	...
	private static byte[][] crearMatrizRandomByte(int iFilas, int iColumnas, byte bMin, byte bMax) {
		...
		for (int iContadorFilas = 0; iContadorFilas < aMatriz.length; iContadorFilas++) {
			for (int iContadorColumnas = 0; iContadorColumnas < aMatriz[iContadorFilas].length; iContadorColumnas++) {
				aMatriz[iContadorFilas][iContadorColumnas] = (byte) ((bMin)
	...
	private static short[][] crearMatrizRandomShort(int iFilas, int iColumnas, short shMin, short shMax) {
		...
		for (int iContadorFilas = 0; iContadorFilas < aMatriz.length; iContadorFilas++) {
			for (int iContadorColumnas = 0; iContadorColumnas < aMatriz[iContadorFilas].length; iContadorColumnas++) {
				aMatriz[iContadorFilas][iContadorColumnas] = (short) ((shMin)
						+ Math.floor(Math.random() * (shMax - shMin)));
			}
		}
		return aMatriz;
	}
	...
	private static long[][] crearMatrizRandomLong(int iFilas, int iColumnas, long lMin, long lMax) {
		...
		for (int iContadorFilas = 0; iContadorFilas < aMatriz.length; iContadorFilas++) {
			for (int iContadorColumnas = 0; iContadorColumnas < aMatriz[iContadorFilas].length; iContadorColumnas++) {
				aMatriz[iContadorFilas][iContadorColumnas] = (long) ((lMin)
						+ Math.floor(Math.random() * (lMax - lMin)));
			}
		}
		return aMatriz;
	}
