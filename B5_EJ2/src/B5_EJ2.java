...
public class B5_EJ2 {
	...
	public static void main(String[] args) {
		int[] aVector = crearVectorRandomInt(10, 1000000, 2000000);
		short shMax = (short) PosicionNumeroMax(aVector), shMin = (short) PosicionNumeroMin(aVector);

		System.out.println("En el vector [" + imprimeVectorInt(aVector) + "].\nEl elemento con mayor valor de "
				+ aVector[shMax] + " esta en la posicion " + shMax + ".\nEl elemento con menor valor de " + aVector[shMin]
				+ " en la posicion " + shMin + ".");
	...
	public static int PosicionNumeroMin(int[] aVector) {
		int iPosicionValorMin = 0;
		for (int iValorControl = 1; iValorControl < aVector.length; iValorControl++) {
			if (aVector[iPosicionValorMin] > aVector[iValorControl]) {
				iPosicionValorMin = iValorControl;
			}
		}
		return iPosicionValorMin;
	}
