...
public class B7_EJ53 {

	public static void main(String[] args) {
		short shNumeroAsteriscos;
		String sAsteriscos = "";
		
		shNumeroAsteriscos =(short) leer("Introduce un numero ", 1, 500, -1, -1, (byte) 2);
		
		for (short shContadorAscendente1 = 0; shContadorAscendente1 < shNumeroAsteriscos; shContadorAscendente1++) {
			for (short shContadorAscendete2 = 0; shContadorAscendete2 <= shContadorAscendente1; shContadorAscendete2++) {
				sAsteriscos += "*";
			}
			sAsteriscos += "\n";
		}
		
		for (short shContadorDescendente1 = (short) (shNumeroAsteriscos - 1); shContadorDescendente1 > 0; shContadorDescendente1--) {
			for (short shContadorDescendente2 = shContadorDescendente1; shContadorDescendente2 > 0; shContadorDescendente2--) {
				sAsteriscos += "*";
			}
			sAsteriscos += "\n";
		}

		System.out.println(sAsteriscos);
	}
