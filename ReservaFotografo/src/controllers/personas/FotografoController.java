...
public class FotografoController implements ICrudController<Fotografo>{
	 ...
	 * ######## # CRUD # ########
	 */
	public boolean add(Fotografo oFotografo, Connection oConnection) {
	...
	public boolean remove(Fotografo oFotografo, Connection oConnection) {
		boolean bExito = false;
		if (oFotografo != null) {
			try {
				Statement stmt = oConnection.createStatement();
	...
	public boolean update(Fotografo oFotografo, Connection oConnection) {
		boolean bExito = false;
		if (oFotografo != null && oFotografo.checkFotografo()) {
	...
	public Fotografo searchByPk(Fotografo oFotografo, Connection oConnection) {
