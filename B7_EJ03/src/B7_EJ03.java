...
public class B7_EJ03 {

	public static void main(String[] args) {
		long lNumero = (long) leer("Introduce un numero entero ", -10000000, 10000000, -1, -1, (byte) 4);
		
		if (String.valueOf(lNumero).charAt(0) == '-') {
			System.out.println("El numero "+ lNumero +" tiene "+(String.valueOf(lNumero).length() - 1)+" cifras");
		} else {
			System.out.println("El numero "+ lNumero +" tiene "+String.valueOf(lNumero).length()+" cifras");
		}
