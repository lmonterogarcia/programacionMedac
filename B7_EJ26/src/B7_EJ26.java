...
public class B7_EJ26 {

	public static void main(String[] args) {
		short shNumero;
		boolean booNumeroNegativo = false;
		final byte BNUMEROS = 30;
		
		for (byte bContador = 0; bContador < BNUMEROS; bContador++) {
			shNumero = (short) leer("Introduce un numero entero ", -1000, 1000, -1, -1, (byte) 2);
			
			if (shNumero < 0) {
				booNumeroNegativo = true;
			}
		}
		
		if (booNumeroNegativo) {
			System.out.println("\nSe ha introducido al menos un numero negativo.");
		} else {
