...
public class B7_EJ07 {

	public static void main(String[] args) {
		byte bNumero = (byte) leer("Introduce un numero ", 0, 10, -1, -1, (byte) 1);
		
		System.out.println("\nEl numero "+bNumero+" se escrbe: "+deNumeroToLetras(bNumero));
	}

	private static String deNumeroToLetras(byte bNumero) {
		String sNumero;
