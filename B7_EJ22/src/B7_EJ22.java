...
public class B7_EJ22 {

	public static void main(String[] args) {
		byte bContadorSueldoMayor = 0;
		final byte BNUMEROSSUELDOS = 50;
		short shSueldo;
		final short SHSUELDOREFERENCIA = 1500;
		int iSumaSueldos = 0;
		
		for (byte bContador = 0; bContador <= BNUMEROSSUELDOS; bContador++) {
			
			shSueldo = (short) leer("Introduce el sueldo ", 950, 5000, -1, -1, (byte) 2);
			iSumaSueldos += shSueldo;
			
			if (shSueldo > 1500) {
				bContadorSueldoMayor++;
			}
			
		}

		System.out.println("\nLa suma de todos los sueldos es "+iSumaSueldos+". Y hay "+bContadorSueldoMayor+" sueldos mayores de "+SHSUELDOREFERENCIA+".");
	}
