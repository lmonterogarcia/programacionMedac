...
public class B6_EJ4 {
	...
	public static void main(String[] args) {
		float[] aVector =  {0.7f, 0.1f, 0.5f, 0.9f};
//		float [] aVector = crearVectorRandomFloat(10, 0, 1);
//		System.out.println(imprimeVectorFloat(aVector));
		
		System.out.println(imprimeVectorBoolean(probabilidadBooleano(aVector)));		
	}
	...
	private static boolean[] probabilidadBooleano(float[] aVector) {
		boolean[] aVectorBooleano = new boolean[aVector.length];
		
		for (int iElementos = 0; iElementos < aVectorBooleano.length; iElementos++) {
			aVectorBooleano[iElementos] = Math.random() < aVector[iElementos];
		}
		
		return aVectorBooleano;
	}
