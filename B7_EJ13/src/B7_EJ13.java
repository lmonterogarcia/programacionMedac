...
public class B7_EJ13 {

	public static void main(String[] args) {
		byte bNumeroAdivinar = (byte) leer("Introduce el numero a adivinar", 1, 100, -1, -1, (byte) 1), bNumero;
		System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
		do {
			bNumero = (byte) leer("Introduce el numero que crees que es ", 1, 100, -1, -1, (byte) 1);
			
			if (bNumero != bNumeroAdivinar) {
				if (bNumero < bNumeroAdivinar) {
		...
		} while (bNumero != bNumeroAdivinar);

		System.out.println("Has acertado, el numero es "+bNumeroAdivinar+".");
	}
