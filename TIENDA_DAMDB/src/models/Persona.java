...
public abstract class Persona implements IPersona {
	...
	public void setsNumeroDireccion(String sNumeroDireccion) {
		if (sNumeroDireccion != null && !sNumeroDireccion.isEmpty() && sNumeroDireccion.length() < MAXCARACTERES) {
	...
	public void setsTelefono(String sTelefono) {
		if (sTelefono != null && !sTelefono.isEmpty() && sTelefono.length() == 9 && sTelefono.matches("\\d+"))
