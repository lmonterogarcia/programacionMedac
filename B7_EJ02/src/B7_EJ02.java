...
public class B7_EJ02 {

	public static void main(String[] args) {
		int[] aVector = objectToIntVector(leerVector("Introduce un numero ", 3, -33000, 33000, -1, -1, (byte) 3)) ;
		aVector = ordenarVectorBurbuja(aVector);
		
		System.out.println("Los numero ordenados de menor a mayor: "+ imprimeVectorInt(aVector));
	}
