...
public class B7_EJ06 {

	public static void main(String[] args) {

		short shAnio = (short) leer("Introduce el anio ", 1, 3000, -1, -1, (byte) 2), shNextAnio;
		boolean booBisiesto = esBisiesto(shAnio);
		byte  bMes = (byte) leer("Introduce el mes ", 1, 12, -1, -1, (byte)1), bDiaMax = diaMaxFecha(bMes, booBisiesto), bDia = (byte) leer("Introduce el dia ", 1, bDiaMax, -1, -1, (byte) 1), bNextDia, bNextMes;
		...
		System.out.println("\nEl dia siguiente a " + bDia + "/" + bMes + "/" + shAnio + " es " + bNextDia + "/" + bNextMes
				+ "/" + shNextAnio);
