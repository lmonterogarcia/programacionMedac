...
public class B7_EJ24 {

	public static void main(String[] args) {
		byte bNumeroSueldos = (byte) leer("Introduce el numero de sueldos a evaluar ", 1, 50, -1, -1, (byte) 1);
		short shSueldo, shSueldoMax = 950;
		
		for (byte bContador = 0; bContador < bNumeroSueldos; bContador++) {
			System.out.println("Sueldo "+(bContador + 1));
			shSueldo = (short) leer("Introduce el sueldo ", 950, 5000, -1, -1, (byte) 2);
			
			if (shSueldo > shSueldoMax) {
				shSueldoMax = shSueldo;
			}
		}
		
		System.out.println("\nEl sueldo maximo es "+shSueldoMax+"€.");
