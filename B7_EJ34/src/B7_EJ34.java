...
public class B7_EJ34 {

	public static void main(String[] args) {
		String sMensaje = "Vaya Navidades que me has dado";
//		String sMensaje = (leer("Introduce el mensaje: ", -1, -1, -1, -1, (byte) 9).toString());

//		byte bClave = (byte) leer("Introduce la clave numerica para encriptar el mensaje ", 1, 50, -1, -1, (byte) 1);
		byte bClave = (byte) leer("Introduce la clave numerica para encriptar el mensaje ", 1, 120, -1, -1, (byte) 1);//Utilizar con el metodo ASCII
		System.out.println("\nMensaje encriptado:\n" + encriptarMensaje(stringSimpleToCharVector(sMensaje), bClave));
	...
	private static String encriptarMensaje(char[] aMensaje, byte bClave) {

		//Version 1
//		String sMensaje = "";
//		char[] aAlfabeto = { 'A', 'a', '9', 'E', 'e', 'I', 'i', 'O', 'o', '3', 'U', 'u', 'B', 'b', 'C', 'c', '7', 'D',
//				'd', 'F', 'f', 'G', 'g', 'H', 'h', 'J', 'j', '6', 'K', 'k', 'L', 'l', '5', 'M', 'm', '2', 'N', 'n','Ñ','ñ', '8',
...
//			if (booEsElCaracter) {
//
//				if ((bClave + (bContadorAlfabeto - 1)) > (aAlfabeto.length - 1)) {
//					sMensaje += aAlfabeto[(bClave - ((aAlfabeto.length - 1) - (bContadorAlfabeto - 1))) - 1];
//				} else {
...
//		}
		...
		for (int iContador = 0; iContador < aMensaje.length; iContador++) {
				...
				if (aMensaje[iContador] + bClave > shFinalAbc ) {
					sMensaje += (char)(bInicioAbc + (bClave - (shFinalAbc - aMensaje[iContador])));
				} else {
