...
public class B7_EJ20 {

	public static void main(String[] args) {
		byte bContadorPositivos = 0, bContadorNegativos = 0, bContadorCeros = 0;
		short shNumero;
		float fPositivosMedia, fNegativosMedia;
		int iTotalPositivos = 0, iTotalNegativos = 0;
		final byte BTOTALNUMEROS = 25;

		for (byte bContador = 0; bContador < BTOTALNUMEROS; bContador++) {
			System.out.println("Numero "+(bContador + 1));
			shNumero = (short) leer("Introduce un numero entero ", -30000, 30000, -1, -1, (byte) 2);

			if (shNumero < 0) {
				bContadorNegativos++;
				iTotalNegativos += shNumero;
			} else if (shNumero > 0) {
				bContadorPositivos++;
				iTotalPositivos += shNumero;
			} else {
				bContadorCeros++;
			}
		...
		fPositivosMedia = iTotalPositivos / bContadorPositivos;
		fNegativosMedia = iTotalNegativos / bContadorNegativos;
		
		System.out.println("\nLa media de los numeros positivos es: " + fPositivosMedia
				+ "\nLa media de los numeros negativos es: " + fNegativosMedia
				+ "\nSe han introducido " + bContadorCeros + " ceros.");
