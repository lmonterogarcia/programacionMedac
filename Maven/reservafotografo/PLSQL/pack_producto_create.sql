CREATE DEFINER=`fotografo`@`%` PROCEDURE `reservafotografo`.`pack_producto_create`(IN oObject JSON)
BEGIN
	...
	ELSE
        ...
        IF vItems > 0 THEN 
            WHILE vIndex < vItems DO
                ...
                INSERT INTO Pack_Producto VALUES (`nombrePackParam`, `nombreProductoParam`);
