...
public class B7_EJ09 {

	public static void main(String[] args) {
		short shNumero = (short) leer("Introduce un numero ", 0, 9999, -1, -1, (byte) 2);

		System.out.println("\nEl numero " + shNumero + " se escribe \"" + primeraLetraMayus(deNumeroToLetrasHasta9999(shNumero))+"\".");
	}
