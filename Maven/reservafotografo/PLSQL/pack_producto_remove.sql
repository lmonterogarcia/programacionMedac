CREATE DEFINER=`fotografo`@`%` PROCEDURE `reservafotografo`.`pack_producto_remove`(IN oObject JSON)
BEGIN
	...
	ELSE
        ...
        IF vItems > 0 THEN 			
            WHILE vIndex < vItems DO
            	...
            	DELETE FROM Pack_Producto  WHERE nombrePack = nombrePackParam AND nombreProducto = nombreProductoParam;
