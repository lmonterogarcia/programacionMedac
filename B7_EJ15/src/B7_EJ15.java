...
public class B7_EJ15 {

	public static void main(String[] args) {
		String sContraseña = "aurelio", sIntento;
		boolean booPassword;
		byte bContadorcaracteres;
		
//		Version 1
		do {
			sIntento = (leer("Introduce la contraseña: ", -1, -1, -1, -1, (byte) 9)).toString();

			if (sContraseña.length() == sIntento.length()) {
			
				booPassword = true;
				bContadorcaracteres = (byte) sContraseña.length();
				
				do {

					if (sContraseña.charAt(bContadorcaracteres - 1) != sIntento.charAt(bContadorcaracteres - 1)) {
						booPassword = false;
					}
					bContadorcaracteres--;

				} while (booPassword && bContadorcaracteres > 0);
...
//			
//			
//			if (!sIntento.equals(sContraseña)) {
//				System.err.println("Contraseña incorrecta, intente de nuevo.\n");
//			}
//			
//			
//		} while (!sIntento.equals(sContraseña));
//
//		System.out.println("\nContraseña correcta");
	}
